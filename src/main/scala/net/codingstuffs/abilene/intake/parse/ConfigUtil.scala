...
import net.codingstuffs.abilene.simulation.generators.random.{Beta, Discrete, FoldedGaussian, Uniform}
...
object ConfigUtil {
  ...
  final val DECISION_MODEL: DecisionMakingModel = {
    config.getString("agent.decision.model") match {
